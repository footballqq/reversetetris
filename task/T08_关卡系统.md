...
### 8.1 关卡配置结构
- [x] 创建 `src/levels/LevelConfig.ts`
```typescript
...
### 8.2 关卡生成器
- [x] 创建 `src/levels/LevelGenerator.ts`
- [x] `generateLevel(id)`: 根据关卡 ID 生成配置
- [x] 难度曲线算法
...
### 8.5 随机模式
- [x] `generateRandomLevel(difficulty)`: 生成随机关卡
- [x] 无尽模式：逐渐增加难度

### 8.6 关卡数据存储
- [x] 关卡进度保存（localStorage）
- [x] 最高分记录
